...
#define TFT_BL 27
Arduino_DataBus *bus = new Arduino_ESP32SPI(14 /* DC */, 15 /* CS */, 2 /* SCK */, 13 /* MOSI */, GFX_NOT_DEFINED /* MISO */);
Arduino_GFX *gfx = new Arduino_ST7789(bus, -1 /* RST */, 0 /* rotation */, true /* IPS */);

#elif defined(ESP32_2432S032)
#define TFT_BL 27
